...
async function verInfo(){
    try{
        ...
        if(respuesta.status==200){
            ...
            document.getElementById("nom1").innerHTML=datos.drinks[0].strInstructions;
            document.getElementById("img2").src=datos.drinks[1].strDrinkThumb;
            document.getElementById("nom2").innerHTML=datos.drinks[1].strInstructions;
        }
else{
    alert("Datos no encontrados, intentelo de nuevo");
}
